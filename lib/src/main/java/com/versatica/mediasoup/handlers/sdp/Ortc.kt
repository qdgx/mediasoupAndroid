 ...
 * @return {RTCRtpParameters}
 */
fun getReceivingFullRtpParameters(kind: String, extendedRtpCapabilities: RTCExtendedRtpCapabilities): RTCRtpParameters {
    val params = RTCRtpParameters(
        muxId = null,
        codecs = arrayListOf(),
        headerExtensions = arrayListOf(),
...
fun matchCapHeaderExtensions(aExt: RTCRtpHeaderExtensionCapability, bExt: RTCRtpHeaderExtensionCapability): Boolean {
